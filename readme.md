<div style="display: flex; align-items: center; gap: 20px;">
  ...
  <div>
    ...
    <p>Telegram-бот для студентов ФГБОУ ВО "Брянский государственный инженерно-технологический университет". Предоставляет актуальное расписание занятий, информацию о преподавателях и удобный доступ к прочей учебной информации.</p>
...
- Использование FSM (Finite State Machine) для управления диалогами
- Middleware для ограничения частоты запросов (anti-spam)
- Автоматический пропуск выходных дней в расписании
